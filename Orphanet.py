...
{% do SectionField(
    name='data',
    title='Load Data',
    subtitle='Upload Files from the Orphanet Genes and Rare Diseases Data Set',
) %}
# %% [markdown]
# # Load Data
# %%
...
tree = ET.parse({{FileField(
    constraint='.*\.xml$',
    name='gene_diseases', 
    label='Genes Associated with Rare Diseases', 
